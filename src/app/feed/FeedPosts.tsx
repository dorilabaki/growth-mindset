      ...
      {feedPosts.map((post, index) => (
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white" aria-hidden="true">
          ...
          <div className="flex items-center gap-6 pt-4 border-t border-neutral-100">
            <div className="flex items-center gap-2 text-neutral-600" aria-label={`${post.likes.toLocaleString()} likes`}>
            ...
            <div className="flex items-center gap-2 text-neutral-600" aria-label={`${post.comments.toLocaleString()} comments`}>
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
            ...
            {post.reposts && (
              <div className="flex items-center gap-2 text-neutral-600" aria-label={`${post.reposts.toLocaleString()} reposts`}>
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
